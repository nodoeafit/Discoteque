...
namespace Discoteque.API.mocks;
...
public static class PopulateDb
{
    public static async Task FillDb(WebApplication app)
    {
        ...
        {
            // var dbContext = scope.ServiceProvider.GetRequiredService<DiscotequeContext>();
            ...
            await _authService.Register(new Data.Models.User
            {
                Username = "admin",
                PasswordHash = "admin",
            ...
            await _userService.CreateUser(new Data.Models.User
            {
                Username = "user",
                PasswordHash = "user",
                Email = "user@user.com",
